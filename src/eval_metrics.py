...
def print_metrics(gt, predict):
    ...
    eval_info = (f"example_subset_accuracy: {ex_subset_acc} \n"
                 f"example_accuracy: {ex_acc}\n"
                 f"example_precision: {ex_precision}\n"
                 f"example_recall: {ex_recall}\n"
                 f"example_f1: {ex_f1}\n"
                 f"label_accuracy_macro: {lab_acc_macro}\n"
                 f"label_precision_macro: {lab_precision_macro}\n"
                 f"label_recall_macro: {lab_recall_macro}\n"
                 f"label_f1_macro: {lab_f1_macro}\n"
                 f"label_accuracy_micro: {lab_acc_micro}\n"
                 f"abel_precision_micro: {lab_precision_micro}\n"
                 f"label_recall_micro: {lab_recall_micro}\n"
                 f"label_f1_micro: {lab_f1_micro}\n")
    return eval_info
